				...
				<div class="page-content">
					...
					<form class="form-horizontal" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" min="1" class="form-control col-xs-10 col-sm-5" name="nickname" value="{$nickname}" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" min="1" class="form-control col-xs-10 col-sm-5" name="password" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" min="1" class="form-control col-xs-10 col-sm-5" name="email" />
							</div>
						</div>
